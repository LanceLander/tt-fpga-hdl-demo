      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_calc
               ...
               (* keep *) logic [2:0] \///?$valid_or_reset@1$op ;
               assign \///?$valid_or_reset@1$op = FpgaPins_Fpga_CALC_op_a1;
               ...
               (* keep *) logic [7:0] \///?$valid_or_reset@1$val2 ;
               assign \///?$valid_or_reset@1$val2 = FpgaPins_Fpga_CALC_val2_a1;
               (* keep *) logic  \///@1$valid ;
         ...
         //_/fpga
            //_\source top.tlv 49   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+calc.
               ...
               //_|calc
                  ...
                  //_@1
                     //$valid[0] = $reset ? 0 : (>>1$valid[0] + 1); //old valid
                     assign FpgaPins_Fpga_CALC_valid_a1 = FpgaPins_Fpga_CALC_reset_a1 ? 0 :
                              ((FpgaPins_Fpga_CALC_equals_in_a1 == 1) && (FpgaPins_Fpga_CALC_equals_in_a2 == 0)) ? 1 : 0;
                  ...
                  //_?$valid_or_reset
                     //_@1
                        ...
                        assign FpgaPins_Fpga_CALC_val2_a1[7:0] = {4'b0000, ui_in[3:0]};
                  ...
                  //_@2
                     assign FpgaPins_Fpga_CALC_out_a2[7:0] = FpgaPins_Fpga_CALC_reset_a2 ? '0 :
                                 !FpgaPins_Fpga_CALC_valid_a2 ? FpgaPins_Fpga_CALC_out_a3 :
                                 (FpgaPins_Fpga_CALC_op_a2 == 3'b100) ? FpgaPins_Fpga_CALC_mem_a4[7:0] :
                     ...
                     assign FpgaPins_Fpga_CALC_mem_a2[7:0] = FpgaPins_Fpga_CALC_reset_a2 ? '0 :
                                !FpgaPins_Fpga_CALC_valid_a2 ? FpgaPins_Fpga_CALC_mem_a3 :
                                (FpgaPins_Fpga_CALC_op_a2 == 3'b101) ? FpgaPins_Fpga_CALC_out_a4[7:0] :
                                                  FpgaPins_Fpga_CALC_mem_a3;
            
            
                  //_@3
                     assign FpgaPins_Fpga_CALC_digit_a3[3:0] = FpgaPins_Fpga_CALC_out_a3[3:0];
                     assign uo_out = (FpgaPins_Fpga_CALC_digit_a3 == 4'b0000) ? 8'b00111111 : //0
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b0001) ? 8'b00000110 : //1
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b0010) ? 8'b01011011 : //2
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b0011) ? 8'b01001111 : //3
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b0100) ? 8'b01100110 : //4
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b0101) ? 8'b01101101 : //5
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b0110) ? 8'b01111101 : //6
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b0111) ? 8'b00000111 : //7
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b1000) ? 8'b01111111 : //8
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b1001) ? 8'b01101111 : //9
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b1010) ? 8'b01110111 : //A
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b1011) ? 8'b01111100 : //B
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b1100) ? 8'b00111001 : //C
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b1101) ? 8'b01011110 : //D
                               (FpgaPins_Fpga_CALC_digit_a3 == 4'b1110) ? 8'b01111001 : //E
                                                     8'b01110001;  //F
               ...
               //_\source /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv 4   // Instantiated from top.tlv, 111 as: m5+cal_viz(@2, /fpga)
                  // Only for Makerchip.
